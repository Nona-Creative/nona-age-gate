...
class Nona_Age_Gate {
	...
	/**
	 * The single instance of Nona_Age_Gate.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		...
		if ( is_admin() ) {
			$this->admin = new Nona_Age_Gate_Admin_API();
		}
	...
	public function load_localisation () {
		load_plugin_textdomain( 'nona-age-gate', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	/**
	 * Main Nona_Age_Gate Instance
	 *
	 * Ensures only one instance of Nona_Age_Gate is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Nona_Age_Gate()
	 * @return Main Nona_Age_Gate instance
	 */
